...
async def get_thumb(videoid):
    ...
    image3.text((670, 450), text=views, fill="white", font=font2, align="left")
    background = image2.filter(filter=ImageFilter.BoxBlur(12))
    enhancer = ImageEnhance.Brightness(background)
    background = enhancer.enhance(0.6)
    draw = ImageDraw.Draw(background)
    arial = ImageFont.truetype("AdRenalen/assets/font2.ttf", 30)
    font = ImageFont.truetype("AdRenalen/assets/font.ttf", 30)
    title_font = ImageFont.truetype("AdRenalen/assets/font3.ttf", 45)
    ...
    draw.text((text_x_position, 320), f"Source AdRenalen", (255, 255, 255), font=arial)
    ...
    play_icons = Image.open("AdRenalen/assets/play_icons.png")
